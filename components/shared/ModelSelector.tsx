...
const models: {
  ...
  { id: 'gemini', nameAr: 'سرعة', nameEn: 'Speed', icon: <Zap className="h-4 w-4" />, speed: 'fast', quality: 'high' },
  { id: 'gpt', nameAr: 'جودة', nameEn: 'Quality', icon: <Sparkles className="h-4 w-4" />, speed: 'medium', quality: 'highest' },
  { id: 'flux', nameAr: 'إبداع', nameEn: 'Creative', icon: <Palette className="h-4 w-4" />, speed: 'slow', quality: 'creative' },
];
